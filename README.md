...
- **Derived state over stored state** — streaks are computed, not persisted  
- **Offline-first by default** — usable without an internet connection  
- **Clear separation of concerns** — tracking, editing, and reviewing are distinct  
